                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                                        ...
                                        <ul class="specification-layout2 mb-40">
                                            ...
                                            <ul>
                                            @if($cust->status==0)
                                            <li><a href="{{url('edit_page/'.$cust->id)}}"><button type="button"  class="pull-left mj_btn btn btn-primary">Edit</button></a></li>
                                            <li><a href="{{url('delete/'.$cust->id)}}"><button type="submit"  class="pull-left mj_btn btn btn-danger">delete</button></a></li>
                                            @endif

                                            @if($cust->status==1)
                                             <li><a href="{{url('edit_page/'.$cust->id)}}"><button type="submit" class="pull-left mj_btn btn btn-warning">Edit</button></a></li>
                                            <li><a href="{{url('delete/'.$cust->id)}}"><button type="submit"  class="pull-left mj_btn btn btn-danger">delete</button></a></li>
                                            <li><a href="{{url('sold/'.$cust->id)}}"><button type="submit"  class="pull-left  mj_btn btn btn-success"  value="3">sold</button></a></li>
                                            @endif
                                            
                                            @if($cust->status==2)
                                            <li><button type="submit"  class="pull-left mj_btn btn btn-danger">delete</button></li>
                                            @endif
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12 col-12 mb--sm">
                                        ...
                                        <ul class="sidebar-item-details p-none"  style="margin-bottom: 30px;">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="sidebar-item-box">
                            <div class="gradient-wrapper">
                                <div class="gradient-title">
                                {{-- <form action="{{url('addetails')}}" method="get" enctype="multipart/form-data">
                                 {{csrf_field()}} --}}
