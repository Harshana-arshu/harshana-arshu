...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/category-grid-layout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:37:51 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>ClassiPost | Grid View Two</title>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <ul class="rt-mega-items">
                                                                    ...
                                                                    <li class="active"><a href="category-grid-layout2.html">Grid View 2</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="form-group search-input-area ">
                               ...
                               @foreach ($stha as $sthalam )
                               <option>{{$sthalam->name}}</option>
                                @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12 text-right text-left-mb">
                            <button type="submit" onclick="{{'search_index/'}}" class="cp-search-btn">
                    ...
                    <div class="order-xl-2 order-lg-2 col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="gradient-wrapper item-mb">
                                    ...
                                    <div class="col-8">
                                        <div class="layout-switcher">
                                            <ul>
                                                ...
                                                <li class="active"><a href="#" data-type="category-grid-layout2" class="product-view-trigger"><i class="fa fa-th-large"></i></a></li>
                                                <li><a href="#" data-type="category-list-layout2" class="product-view-trigger"><i class="fa fa-list"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="category-view" class="category-grid-layout2 gradient-padding zoom-gallery">
                                <div class="row">
                                  @foreach($searchi as $search)
                                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12">
                                    
                                        <div class="product-box item-mb zoom-gallery">
                                            <div class="item-mask-wrapper">
                                                <div class="item-mask secondary-bg-box"><img src="{{url('uploads/'.$search->image)}}" alt="categories" class="img-fluid">
                                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                    @foreach($search->caty as $model)
                                                    <div class="title-ctg">{{$model->category_name}}
                                                    @endforeach
                                                    </div>
                                                    <ul class="info-link">
                                                        <li><a href="{{url('uploads/'.$search->image)}}" class="elv-zoom" data-fancybox-group="gallery" title="Title Here"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
                                                        <li><a href="{{url('inner_page/'.$search->id)}}"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                    <div class="symbol-featured"><img src="img/banner/symbol-featured.png" alt="symbol" class="img-fluid"> </div>
                                                </div>
                                            </div>
                                            <div class="item-content">
                                                <div class="title-ctg">{{$search->ad_title}}</div>
                                                <h3 class="short-title"><a href="{{url('inner_page/'.$search->id)}}">{{$search->ad_title}}</a></h3>
                                                
                                                <ul class="upload-info">
                                                    @foreach($search->location as $custs)
                                                    <li class="place"><i class="fa fa-map-marker" aria-hidden="true"></i>{{$custs->location_name}}</li>
                                                    @endforeach
                                                    @foreach($search->district as $cust)
                                                    <li class="tag-ctg"><i class="fa fa-tag" aria-hidden="true"></i>{{$cust->district_name}}</li>
                                                    @endforeach
                                                </ul>
                        ...
                        <div class="sidebar-item-box">
                            <div class="gradient-wrapper">
                                ...
                                <ul class="sidebar-category-list">
                                    ...
                                    <li>
                                        <a href="{{url('watches/')}}"><img src="{{URL::to('/')}}/assets/img/product/iwatch.png"style="width:30px;height:30px;" alt="category" class="img-fluid">Watches<span>(50)</span></a>
                                    </li>
                                    <li>
                                        <a href="{{url('airpod/')}}"><img src="{{URL::to('/')}}/assets/img/product/airpods.png" style="width:30px;height:30px;"alt="category" class="img-fluid">Airpods<span>(20)</span></a>
                                    </li>
                                    <li>
                                        <a href="{{url('tv/')}}"><img src="{{URL::to('/')}}/assets/img/product/tv.png" style="width:30px;height:30px;"alt="category" class="img-fluid">TV<span>(100)</span></a>
                                    </li>
                                    <li>
                                        <a href="{{url('accessories/')}}"><img src="{{URL::to('/')}}/assets/img/product/ctg6.png" style="width:30px;height:30px;"alt="category" class="img-fluid">Accessories<span>(70)</span></a>
                                    </li>
...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/category-grid-layout2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:38:07 GMT -->
</html>