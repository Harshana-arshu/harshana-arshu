    ...
    <div id="wrapper">
        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
          ...
          @endif
            ...
            <form action="{{url('store_edit')}}" method="post" enctype="multipart/form-data">
             {{csrf_field()}}
            <div class="container">
                <div class="row">
                            ...
                            <div class="input-layout1 gradient-padding post-ad-page">
                                <form id="post-add-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="number" id="phone_number" name="phone_number" class="form-control" value="{{$cust->phone_number}}"placeholder="Enter your Mobile">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <textarea placeholder="What makes your ad unique" class="textarea form-control" name="address" id="description" rows="4" cols="20" data-error="Message field is required" required>{{$cust->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <button type="submit" name="save" class="btn btn-sm btn-primary pull-right">Update!</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
