...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/single-product-layout3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:39:45 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>ClassiPost | Single Product Three</title>
...
<body>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <ul class="rt-mega-items">
                                                                    ...
                                                                    <li class="active"><a href="single-product-layout3.html">Product Details 3</a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="form-group search-input-area input-icon-category">
                                <select id="categories" class="select2">
                                    ...
                                    @foreach($cat as $caty)
                                    <option value="1">{{$caty->name}}</option>
                                    @endforeach
        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="gradient-wrapper item-mb">
                            ...
                            <div class="gradient-padding reduce-padding">
                                <div class="single-product-img-layout1 d-flex mb-50">
                                    <ul class="nav tab-nav tab-nav-list">
                                     @foreach($image as $img)
                                        <li class="nav-item">
                                            <a  href="#{{$img->id}}" data-toggle="tab" aria-expanded="false"><img alt="related1" src="{{url('uploads/'.$img->img_name)}}" class="img-fluid"></a>
                                        </li>
                                      @endforeach  
                                       
                                    </ul>
                                    <div class="tab-content">
                                        <span class="price">{{$cust->price}}</span>

                                        @foreach($image as $img)
                                        <div class="tab-pane fade active show" id="{{$img->id}}">
                                            <a href="#" class="zoom ex1"><img alt="single" src="{{url('uploads/'.$img->img_name)}}" class="img-fluid"></a>
                                        </div>
                                        @endforeach
                                                                            </div>
                                </div>
                                <div class="section-title-left-dark child-size-xl title-bar item-mb">
                                    ...
                                    <p class="text-medium-dark">{{$cust->description}} </p>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                                        ...
                                        <ul class="specification-layout2 mb-40">
                                            <li>{{$cust->storage_capacity}}</li>
                                            <li>{{$cust->age}} used</li>
                                            <li>{{$cust->BH}} battery life</li>
                                            <li>Damaged Item:{{$cust->damage}}</li>
                                            <li>Damaged Details:{{$cust->damage_details}}</li>
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12 col-12 mb--sm">
                                        ...
                                        <ul class="sidebar-item-details p-none">
                                            <li>Condition:<span>{{$cust->condition}}</span></li>
                                            <li>Model:@foreach($cust->model as $custs)
                                            <span>{{$custs->model_name}}</span></li>@endforeach
                                            <li>Color:<span>{{$cust->color}}</span></li>
                                            <li>Warranty:<span>{{$cust->warranty}}</span></li>
                                            <li>
                    ...
                    <div class="gradient-wrapper item-mb">
                                <div class="gradient-title">
                                <h3>More Adds From Users</h3></div>
                            <div class="gradient-padding">
                                <div class="cp-carousel nav-control-middle category-grid-layout1" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="2" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="2" data-r-medium-nav="true" data-r-medium-dots="false" data-r-Large="3" data-r-Large-nav="true" data-r-Large-dots="false">
                                   @foreach($more_add as $custs)
                                    <div class="product-box">
                                        <div class="item-mask-wrapper">
                                        
                                            <div class="item-mask secondary-bg-box"><img src="{{url('uploads/'.$custs->image)}}" alt="categories" class="img-fluid">
                                                <div class="trending-sign active" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                @foreach($cust->caty as $custss)
                                                <div class="title-ctg">{{$custss->category_name}}</div>
                                                @endforeach

                                                <ul class="info-link">
                                                    <li><a href="{{url('uploads/'.$custs->image)}}" class="elv-zoom" data-fancybox-group="gallery" title="Title Here"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
                                                    <li><a href="{{url('inner_page/'.$custs->id)}}"><i class="fa fa-link" aria-hidden="true"></i></a></li>
                                                </ul>
                                                
                                                <div class="symbol-featured"><img src="img/banner/symbol-featured.png" alt="symbol" class="img-fluid"> </div>
                                            </div>
                                            <h3 color="green"><B>{{$custs->ad_title}}</B></h3>
                                       <h3>Rs.{{$custs->price}}</h3>
                                        </div>
                                    </div>
                                     @endforeach
                                </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                                <div class="add-layout2-right d-flex align-items-center justify-content-end mb--sm">
                                    <a href="{{url('/post-add')}}" class="cp-default-btn-sm-primary">Post Your Ad Now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="sidebar-item-box">
                            <div class="gradient-wrapper">
                                <div class="gradient-title">
                                {{-- <form action="{{url('inner_page/{id}')}}" method="get" enctype="multipart/form-data">
                                 {{csrf_field()}} --}}
                                ...
                                <ul class="sidebar-seller-information">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img src="{{URL::to('/')}}/assets/img/user/user1.png" alt="user" class="img-fluid pull-left">
                                            <div class="media-body">
                                            
                                       <input type="hidden" name="id" value="{{$cust->id}}">
                                                <span>Posted By</span>
                                                @foreach($cust->user as $custs)
                                                <h4>{{$custs->customername}} </h4>
                                                @endforeach
                                            </div>
                                         </div>
                                    </li>  
                                    <li>
                                         ...
                                         <div class="media">
                                            <img src="{{URL::to('/')}}/assets/img/user/user2.png" alt="user" class="img-fluid pull-left">
                                        
                                             <div class="media-body">
                                            
                                                <span>Location</span>
                                                <h4>{{$cust->address}}</h4>
                                                @foreach($cust->location as $custs)
                                                <h4>{{$custs->location_name}}</h4>   
                                                @endforeach
                                                @foreach($cust->district as $custs)
                                                 <h4>{{$custs->district_name}}</h4>   
                                                @endforeach
                                                <h4>{{$cust->pin}}</h4>
                                    ...
                                    <li>
                                        <div class="media">
                                            <img src="{{URL::to('/')}}/assets/img/user/user3.png" alt="user" class="img-fluid pull-left">
                                            <div class="media-body">
                                                <span>Contact Number</span>
                                                <h4>{{$cust->phone_number}}</h4>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="media">
                                            <img src="{{URL::to('/')}}/assets/img/user/user4.png" alt="user" class="img-fluid pull-left">
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img src="{{URL::to('/')}}/assets/img/user/user5.png" alt="user" class="img-fluid pull-left">
                                            <div class="media-body">
                                                <span>User Type</span>
                                                <h4>Verified</h4>
                                            </div>
                            ...
                            <div class="gradient-wrapper">
                                ...
                                <ul class="sidebar-ads-from-user">
                                 @foreach($more_add as $custs)
                                    <li>
                                        <div class="media">
                                            <a href="#" class=" pull-left"><img src="{{url('uploads/'.$custs->image)}}" alt="categories" class="img-fluid"></a>
                                            <div class="media-body">
                                               

                                                <h4><a href="#">{{$custs->add_title}}</a></h4>
                                               
                                                <div class="place">
                                                @foreach($custs->location as $loc)
                                                <i class="fa fa-map-marker" aria-hidden="true">{{$loc->location_name}}</i></div>
                                                @endforeach
                                                <div class="price">{{$custs->price}}</div>
                                            </div>
                                        </div>
                                    </li>
                                     @endforeach
    ...
    <!-- jQuery Zoom -->
    <script src="{{URL::to('/')}}/assets/js/jquery.zoom.min.js"></script>
    <!-- Google Map js -->
...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/single-product-layout3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:39:51 GMT -->
</html>