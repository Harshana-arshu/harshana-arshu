...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/post-ad.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:35:22 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>ClassiPost | Post Ad</title>
    ...
    <div id="wrapper">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <ul class="rt-mega-items">
                                                                    ...
                                                                    <li class="active"><a href="post-ad.html">Post Ad</a></li>
        ...
        <section class="s-space-bottom-full bg-accent-shadow-body">
          ...
          @endif
            ...
            <form action="{{url('toadd/store')}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
            <div class="container">
                <div class="row">
                        ...
                        <div class="gradient-wrapper">
                            ...
                            <div class="input-layout1 gradient-padding post-ad-page">
                                <form id="post-add-form">
                                    <div class="mb-50 pb-30">
                                        <div class="section-title-left-dark border-bottom d-flex">
                                            <h3><img src="{{URL::to('/')}}/assets/img/post-add1.png" alt="post-add" class="img-fluid"> Product Information</h3>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" class="form-control" name="ad_title" placeholder="Add Title Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="add-title">Model <span> *</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                <div class="custom-select">
                                                    <select id="model" name="model_id" class='select2'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <ul class="picture-upload">
                                                        <li>
                                                            <input type="file" id="img-upload1" name="image1" class="form-control">
                                                        </li>
                                                        <li>
                                                            <input type="file" id="img-upload2" name="image2" class="form-control">
                                                        </li>
                                                        <li>
                                                            <input type="file" id="img-upload3"  name="image3" class="form-control">
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="add-title">Sell Price<span> *</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="add-title" name="price" class="form-control" placeholder="Sell Price">
                                                </div>
                                            </div>
                                      ...
                                      <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label">Warranty<span> *</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="Warranty" name="warranty" class='select2'>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label">color<span>*</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                       ...
                                                       <option value="straightlight">StriaghtLight(Silver)</option>
                                           ...
                                           <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label">Damage On Device<span>*</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="Damage" class='select2'>
                                                       <option value="Select Damage">Select Damage</option> 
                                                       <option value="yes">Yes</option>
                                                       <option value="no">No</option>
                                                      </select>
                                                    </div>
                                                 ...
                                                 <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="add-title">Damage Details<span>*</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="textarea" id="add-title" class="form-control" placeholder="Enter Your Damage Details">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="add-title">Battery Health<span>*</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="BH" name="BH"class="form-control" placeholder="Enter Your Battery Health">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="Capacity" name="storage_capacity" class='select2'>
                                                       <option value="Select capacity">Select Storage Capacity</option> 
                                         ...
                                         <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label">Memory (RAM)<span> *</span></label>
                                            </div>
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="Memory Ram" class='select2'>
                                                       <option value="Select Memory Ram">Select Meomory (RAM)</option> 
                                                       <option value="1 GB or less">32 GB</option>
                                                       <option value="2 GB">64 GB</option>
                                                       <option value="3 GB">128 GB</option>
                                                       <option value="4 GB">256 GB</option>
                                                       <option value="6 GB">512 GB</option>
                                                       <option value="8 GB">1 TB+</option>
                                                       <option value="12 GB or more">Others</option>
                                                     </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                       ...
                                                       <option value="Morthan 3 Year">Morethan 3 years</option>
                                ...
                                <form id="post-add-form">
                                    ...
                                    <div class="mb-50 pb-30">
                                        <div class="section-title-left-dark border-bottom d-flex">
                                            <h3><img src="{{URL::to('/')}}/assets/img/post-add2.png" alt="post-add" class="img-fluid">Seller Information</h3>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="number" id="phone_number" name="phone_number" class="form-control" placeholder="Enter your Mobile">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <textarea placeholder="What makes your ad unique" class="textarea form-control" name="address" id="description" rows="4" cols="20" data-error="Message field is required" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                    <div class="custom-select">
                                                        <select id="district" name="district_id" class='select2'>
                                                        <option>Select District</option>
                                                        @foreach($dist as $orgs)
                                                        <option value="{{$orgs->id}}">{{$orgs->name}}</option>
                                                        @endforeach
                                                     </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 col-12">
                                                <div class="form-group">
                                                        ...
                                                        <option value="select option">Select Location</option></select></div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-12">
                                                <label class="control-label" for="zip-code">Pin Code<span> *</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-12">
                                                <div class="form-group">
                                                    <input type="text" id="zip-code" name="pin"class="form-control" placeholder="Enter Your Pin Code">
                                                     <div class="form-group mt-20">
                                            <button type="submit" name="save" class="btn btn-sm btn-primary pull-right">Submit Now!</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
$.ajax({
         type:"GET",
         url:"{{url('/get-location')}}?district="+district,
...
if(res){
   $("#loc").empty();
              ...
              {  
console.log(value);
                   $("#loc").append('<option style="text-transform: uppercase;" value="'+id+'">'+value+'</option>'); 
              });  
...
$.ajax({
         type:"GET",
         url:"{{url('/get-model')}}?category="+category,
         success:function(res){  
...
if(res){
   $("#model").empty();
              ...
              {  
console.log(value);
                   $("#model").append('<option style="text-transform: uppercase;" value="'+id+'">'+value+'</option>'); 
              });  
...
<!-- Mirrored from radiustheme.com/demo/html/classipost/classipost/post-ad.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Dec 2022 04:35:27 GMT -->
</html>