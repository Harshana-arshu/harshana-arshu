          ...
          @endif
                              ...
                              <form action="{{url('user/store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 col-12">
                                            <div class="form-group">
                                                <input type="number" id="phone" name="phone_number" class="form-control" placeholder="Your Phone Number">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 col-12">
                                            <label class="control-label">Addresss <span>*</span></label>
                                        </div>
                                        <div class="col-sm-9 col-12">
                                            <div class="form-group">
                                                <textarea placeholder="Enter your Address" class="textarea form-control" name="address" id="form-message1" rows="4" cols="20" data-error="Message field is required" required></textarea>
                                            </div>
                                        </div>
                                    </div>
